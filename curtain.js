...
(function ( $, window, document, undefined ) {
	...
	Plugin.prototype = {
		init: function () {
			...
			} else if(navigator.userAgent.match(/mozilla/i) || navigator.userAgent.match(/msie/i)) {
		...
		scrollEvent: function() {
			...
			if(docTop < self.currentP && self.currentIndex > 0){
				...
				self.setCache();
				self.options.prevSlide( self.$current );
				...
				self.setCache();
				self.options.nextSlide( self.$current );
			}
